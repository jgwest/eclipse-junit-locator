...
public class JUnitTestSuiteJson {
	...
	private List<Integer> containedTestClasses = new ArrayList<>();
	...
	public final List<Integer> getContainedTestClasses() {
		return containedTestClasses;
	}

	public final void setContainedTestClasses(List<Integer> containedTestClasses) {
		this.containedTestClasses = containedTestClasses;
	}
